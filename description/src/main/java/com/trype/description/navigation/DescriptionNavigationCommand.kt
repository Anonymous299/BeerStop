...
class DescriptionNavigationCommand @Inject constructor() : DescriptionNavigation {
    override fun descriptionCommand(alcohol: Alcohol) = object: NavigationCommand {
        override val arguments: List<NamedNavArgument> = emptyList()

        override val destination = "${NavigationDestinations.DescriptionDestination.base_route}/$alcohol"
    }
}